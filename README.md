...
No Computador (Código e Site):
Para construir o site do Agrinho, a gente usou a combinação clássica da internet: HTML para montar a estrutura, CSS para deixar o visual bonito e com as cores da natureza, e JavaScript para fazer os botões e os efeitos funcionarem. Todo o código foi escrito usando o editor VS Code (Visual Studio Code).
